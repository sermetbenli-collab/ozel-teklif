...
// yanıtlar ve çalışmayı arkada sürdürür (10 saniyelik senkron limit yerine 15 dakikaya
// kadar süre tanır). Sonuç, Netlify Blobs üzerinde jobId ile saklanır; tarayıcı tarafı
// extract-status.js fonksiyonunu belirli aralıklarla yoklayarak (polling) sonucu alır.
...
exports.handler = async (event) => {
  ...
  try {
    ...
    return; // Background function: yanıt gövdesi istemciye ulaşmaz, sadece loglanır.
  }
