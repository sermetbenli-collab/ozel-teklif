...
//
// MODERN Netlify Functions formatı: "export default" + "export const config = { background: true }".
// Bu, arka plan fonksiyonlarını tanımlamanın güncel (resmi dokümantasyonda önerilen) yoludur;
// eski "-background.js" dosya adı kuralı yerine geçmiştir. 202 ile hemen yanıt verir, iş arkada
// 15 dakikaya kadar sürebilir (Pro planda). Sonuç Netlify Blobs'a jobId ile yazılır; tarayıcı
// extract-status.js'i yoklayarak (polling) sonucu alır.
